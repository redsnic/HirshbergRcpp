...
RcppExport SEXP sourceCpp_1_print_alignment(SEXP s1SEXP, SEXP s2SEXP, SEXP alignmentSEXP) {
BEGIN_RCPP
...
RcppExport SEXP sourceCpp_1_score_alignment(SEXP s1SEXP, SEXP s2SEXP, SEXP is_globalSEXP, SEXP alphabetSEXP, SEXP score_matrixSEXP, SEXP gap_costSEXP, SEXP alignmentSEXP) {
BEGIN_RCPP
...
// read_fasta
std::string read_fasta(String path);
RcppExport SEXP sourceCpp_1_read_fasta(SEXP pathSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
